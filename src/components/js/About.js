                                ...
                                <Col xs="12" sm="12" md="8" lg="8" xl="8">
                                    <div className="left-content">
                                        <div className="content">
                                            ...
                                            <div className="content-spec">
                                                <ul>
                                                    <li><b>Front End Developer<br/>PETOBE (Markham, ON) | Dec 19 ~ Present</b><br/>- Front End Development with React & Redux<br/>- Building Web & Mobile Application (React Native)<br/>- Collaborating with Designers and Backend Team (UI & UX)<br/><br/></li>
